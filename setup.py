...
setup(
    ...
    version='8.1.3',  # Start with a small number and increase it with every change you make
    ...
    download_url='https://github.com/arianseyedi/python-envmanager/archive/v8.1.2.tar.gz',  # I explain this later on
